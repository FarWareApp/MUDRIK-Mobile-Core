export const SECURITY_EVENT_TYPES = [
  ...
  'privacy.reactivation_denied',
  'privacy.sensor_stop_failed',
  'privacy.policy_violation',
  'privacy.observation_unverifiable',
  'privacy.registry_conflict_rejected',
  'voice.input_activation_denied',
  'voice.stream_replay_rejected',
  'voice.barge_in_rejected',
  'voice.provider_failure',
  'voice.lifecycle_violation',
  'replay.rejected',
  'signature.invalid',
  'secret.accessed',
